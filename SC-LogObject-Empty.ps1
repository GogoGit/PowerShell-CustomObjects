...
Write-Host "--- Start of Script:"($MyStartDate)"---"
    ...
    #Create Empty Log File using variables $gAppName and $gLoggingDirectory
    #---------------------------------------------
    $sFunctionSection = "Create Empty Logging File.  0 Sized logged files will be deleted."
    ## Create File
    ...
    Try{
        ...
        Write-Warning "Wait 5 seconds before closing file"
        Start-Sleep -s 5
        ## Delete empty file
